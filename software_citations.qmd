...
#. Epstein, G., Fuller, S. D., Hingmire, D., Myers, P. G., Peña, A., Pennelly, C., and Baum, J. K.: Predictive mapping of organic carbon stocks and accumulation rates in surficial sediments of the Canadian continental margin, Earth Syst. Sci. Data Discuss. [preprint], https://doi.org/10.5194/essd-2023-295, in review, 2023. 
...
#. López-Álvarez, Ó., Franco-Vázquez, L., and Marey-Perez, M. (2023). "Base-age invariant models for predicting individual tree accumulated annual resin yield using two tapping methods in maritime pine (Pinus pinaster Ait.) forests in north-western Spain". Forest Ecology and Management 549: 121501. https://doi.org/10.1016/j.foreco.2023.121501
...
geojsonio is used in (but not cited in) [Chauhan et al 2022](https://doi.org/10.3390/v14112461); [Wang 2023](https://www.routledge.com/Data-Science-for-Infectious-Disease-Data-Analytics-An-Introduction-with/Wang/p/book/9781032187426); [de Souza et al 2022](https://www.mdpi.com/1999-4915/14/10/2311); [Czolk et al 2023](https://doi.org/10.1002%2Fclt2.12292); [Gassiep et al 2023](https://doi.org/10.1371/journal.pntd.0011697).
