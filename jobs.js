module.exports = {
  wayfair_detail: [
    {
      title: 'Analyst',
      team: 'Forecasting & Analytics -- Wayfair, Inc.',
  ...
  stella_lab: [
    {
      ...
      team: 'Stella Riparian and Stream Ecology Laboratory',
  ...
  yanai_lab: [
    {
      ...
      team: 'Yanai Forest Ecosystem Science Laboratory',
  ...
  beaver_intern: [
    {
      title: 'Beaver Impact Assessment Intern',
      team: 'New York State Department of Environmental Conservation',
  ...
  cfb: [
    {
      title: 'Data Scientist / Project Manager (Volunteer)',
      team: 'Code for Boston - Clean Slate Project',
