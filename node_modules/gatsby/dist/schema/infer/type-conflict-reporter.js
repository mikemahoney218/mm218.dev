...
class TypeConflictEntry {
  ...
  addExample({
    ...
    var _ref, _parent$internal;

    this.types.set(type, {
      value,
      description: (_ref = parent === null || parent === void 0 ? void 0 : (_parent$internal = parent.internal) === null || _parent$internal === void 0 ? void 0 : _parent$internal.description) !== null && _ref !== void 0 ? _ref : ``
    });
  }
