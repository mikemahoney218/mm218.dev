...
module.exports.all = async ({
  ...
  const plugins = getPluginsFromConfig(src); // TODO: Consider mapping to read function

  return plugins.map(name => {
    const {
      shadowedFiles,
      shadowableFiles
    } = listShadowableFilesForTheme(root, name);
    return {
      id: name,
      name,
      shadowedFiles,
...
module.exports.plan = async ({
  ...
  src = prettier.format(src, { ...prettierConfig,
    parser: `babel`
  });
