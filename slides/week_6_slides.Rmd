...
samples as we want. I'm going to make 100 because it's a nice round number,
and I'll store them as a list in `ames_bootstraps`:
...
And just like that, we have 100 decision trees! 
...
these to produce a single prediction. 

A surprisingly effective way to do that
