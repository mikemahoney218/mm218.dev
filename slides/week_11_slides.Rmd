...
Three weeks from now (week 14, 2021-12-08, our last day of class) everyone will 
...
Which one would we want to use to classify our data?

---

Well, just by looking at this graph we can tell that some of these hyperplanes 
...
```{r, echo = FALSE, fig.width=10, fig.height=5, message=FALSE, cache=TRUE, warning=FALSE}
...
using cross-entropy or AUC loss like we've done in the past is rarer.
...
from way back in week 7, and lower sensitivity and higher specificity than our
logistic models from week 4. Which of these models is "best" for your data is, 
as usual, a question of what you're looking for.
...
And that's SVM, folks: create new variables to find a linear surface that 
...
So why did we talk about SVM at all?
...
methods, whose hard binary thresholds create a lot of right-edges in the 
