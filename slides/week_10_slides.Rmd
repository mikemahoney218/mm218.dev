...
time getting into the math behind what a "kernel" is today.
...
To talk about the implications of that, let's start actually fitting KNNs in R.
...
This way, a change of 1 means the same across all of our variables.
