...
contribute less to the final prediction. If your data contains many categorical
...
And now we'll set up our tuning grid! We're going to test similar values for C
